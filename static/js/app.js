...
function updateFilters() {
  ...
  if ((filterValue !== filters.filterId) && (filterValue !== '')) {
...
function filterTable() {
  ...
  filteredData = filteredData.filter(function currentElement() {
    return currentElement.datetime === filters.datetime && currentElement.city === filters.city && currentElement.state === filters.state
  });
